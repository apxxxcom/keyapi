...
fetch(`https://api.zahwazein.xyz/downloader/youtube?apikey=zenzkey_4b5ecb6dc8a1&url=${url}`, {
    method: 'GET',
    headers: {
   ...
   .then(response =>
    res.send({
      ...
      size: `${response.result.getAudio.size} Kb`, 
      audio: `${response.result.getAudio.url}`
    }));
    limitAdd(apikey);
})
...
fetch(`https://api.zahwazein.xyz/downloader/youtube?apikey=zenzkey_4b5ecb6dc8a1&url=${url}`, {
   ...
   .then(response =>
    res.send({
      ...
      title: `${response.result.title}`, 
      thumbnail: `${response.result.thumbnail}`, 
      size: `${response.result.getVideo.size} Kb`, 
      audio: `${response.result.getVideo.url}`
    }));
    limitAdd(apikey);
})
// news
